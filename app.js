...
function addExpense(e){
    ...
    let curtype = document.getElementById('currtype').value;

    if(type != 'chooseOne' && name.length > 0 && date != 0 && amount > 0){
        const expense = {user,type,name,date,curtype,amount, id: expenses.length > 0 ? expenses[expenses.length - 1].id + 1 : 1,}
